...
/**
 * Test instanciation of FMLModelFactory for JAVA technology adapter<br>
 * 
 */
@RunWith(OrderedRunner.class)
public class JavaFMLModelFactoryIntegrationTest extends AbstractModelFactoryIntegrationTestCase {

	private static final Logger logger = FlexoLogger.getLogger(JavaFMLModelFactoryIntegrationTest.class.getPackage().getName());
	...
	public void initializeServiceManager() {
		...
		assertNotNull(taService.getTechnologyAdapter(JavaTechnologyAdapter.class));
	}
	...
	@Test
	@TestOrder(2)
	public void checkJavaFMLTechnologyAdapter() {
		log("checkJavaFMLTechnologyAdapter()");

		testVirtualModelModelFactoryWithTechnologyAdapter(
				serviceManager.getTechnologyAdapterService().getTechnologyAdapter(JavaTechnologyAdapter.class));
	}
