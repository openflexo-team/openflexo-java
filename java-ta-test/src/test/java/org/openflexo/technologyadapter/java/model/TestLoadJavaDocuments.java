...
import org.openflexo.ta.java.AbstractJavaTest;
...
public class TestLoadJavaDocuments extends AbstractJavaTest {
	protected static final Logger logger = Logger.getLogger(TestLoadJavaDocuments.class.getPackage().getName());
	...
	@Test
	@TestOrder(4)
	public void testJavaContents() {

		XXText text = getJavaText("Test1.txt");
