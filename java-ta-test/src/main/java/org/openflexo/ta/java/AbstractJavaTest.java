...
public abstract class AbstractJavaTest extends OpenflexoProjectAtRunTimeTestCase {
	protected static final Logger logger = Logger.getLogger(AbstractJavaTest.class.getPackage().getName());

	protected XXTextResource getJavaResource(String documentName, FlexoResourceCenter<?> resourceCenter) {
	...
	protected XXTextResource getJavaResource(String documentName) {

		FlexoResourceCenter<?> resourceCenter = serviceManager.getResourceCenterService()
				.getFlexoResourceCenter("http://www.openflexo.org/test/xx");

		return getJavaResource(documentName, resourceCenter);
	}

	protected XXText getJavaText(String documentName) {

		XXTextResource documentResource = getJavaResource(documentName);
		assertNotNull(documentResource);
