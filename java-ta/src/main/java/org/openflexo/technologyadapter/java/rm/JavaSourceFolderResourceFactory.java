 ...
 *
 */
public class JavaSourceFolderResourceFactory
		extends TechnologySpecificFlexoResourceFactory<JavaSourceFolderResource, JavaSourceFolder, JavaTechnologyAdapter> {
