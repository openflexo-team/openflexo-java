 ...
 * One instance of this class should be used for each {@link JavaCompilationUnitResource}
 * 
 * @author sylvain
 * 
 */
public class JavaModelFactory extends PamelaModelFactory implements PamelaResourceModelFactory<JavaCompilationUnitResource> {

	@SuppressWarnings("unused")
	private static final Logger logger = Logger.getLogger(JavaModelFactory.class.getPackage().getName());

	private final JavaCompilationUnitResource resource;
	private IgnoreLoadingEdits ignoreHandler = null;
	private FlexoUndoManager undoManager = null;

	// private RelativePathResourceConverter relativePathResourceConverter;

	public JavaModelFactory(JavaCompilationUnitResource resource, EditingContext editingContext) throws ModelDefinitionException {
		super(PamelaMetaModelLibrary.retrieveMetaModel(JavaCompilationUnit.class));
